<nav>
        ...
        <li class="<?php if($page=='employee') {echo 'active';} ?>">
            <a href="javascript:void(0)" aria-expanded="true"> <i class="ti-id-badge"></i> <span>Staff Section</span></a>

            <ul class="collapse">
                <li ><a href="add-employee.php"><i class="fa fa-spinner"></i> Add Staff</a></li>
                <li ><a href="employees.php"><i class="fa fa-check"></i> Manage Staff</a></li>
            </ul>
