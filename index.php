<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        $sql ="SELECT EmpId,Dob,Status,id FROM tblemployees WHERE EmpId=:uname and Dob=:password";
            ...
            <div class="login-box">
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <!-- <label for="exampleInputPassword1">dd-mm-yyyy</label> -->
                            <input type="date" id="password" name="password" autocomplete="off" required>
                            <!-- <i class="ti-lock"></i> -->
                            <div class="text-danger"></div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a class="text-light" href="admin/index.php">Go to HOD's Login <i class="ti-arrow-right"></i></a></p>
                        </div>
                    </div>
                </form>
            </div>
